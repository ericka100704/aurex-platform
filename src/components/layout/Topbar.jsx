...
export default function Topbar({
  ...
  return (
    <header className="isolate px-4 pb-2 pt-3 md:px-10 md:pb-3 md:pt-5 lg:px-12">
      <div className="mx-auto flex max-w-[1400px] items-center justify-between gap-3 rounded-2xl border border-white/[0.06] bg-[#121212]/95 px-3.5 py-3 md:gap-6 md:rounded-[1.75rem] md:px-7 md:py-5">
        ...
        <div className="flex shrink-0 items-center gap-1.5 md:gap-3">
          <button
            type="button"
            className="rounded-full border border-white/10 bg-white/[0.04] p-2 text-white/65 transition hover:border-magenta/40 hover:text-white md:p-2.5"
          ...
          <div className="flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] py-1 pl-1 pr-2 md:gap-2.5 md:py-1.5 md:pl-1.5 md:pr-3">
