  ...
  const methods = [
    {
      ...
      qrImageUrl: null,
      instructions: "Send the exact amount to GCash 09242512818 (MABEL HULAR), then upload your receipt.",
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      qrImageUrl: null,
      instructions: "Transfer the exact amount to GoTyme 012774193734 (MABEL HULAR), then upload your receipt.",
      sortOrder: 2,
      isActive: true,
    },
  ];
